...
omicronManager.prototype.connectToTracker = function()
{
	console.log('Connecting to Omicron server: ', this.trackerIP, this.msgPort);
	
	var client = net.connect(this.msgPort, this.trackerIP,  function()
	{ //'connect' listener
	
		var sendbuf = util.format("omicron_data_on,%d", this.dataPort);
