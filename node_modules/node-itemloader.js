...
appLoader.prototype.loadImage = function(file, url, external_url, name, callback) {
...
appLoader.prototype.loadVideo = function(file, url, external_url, name, callback) {
...
appLoader.prototype.loadPdf = function(file, url, external_url, name, callback) {
...
appLoader.prototype.manageAndLoadUploadedFile = function(file, callback) {
	...
	fs.rename(file.path, localPath, function(err) {
		...
		if(app === "image_viewer"){
			_this.loadImage(localPath, url, external_url, file.originalFilename, function(appInstance){
				callback(appInstance);
			});
		}
		else if(app === "movie_player"){
			_this.loadVideo(localPath, url, external_url, file.originalFilename, function(appInstance){
				callback(appInstance);
			});
		}
		else if(app === "pdf_viewer"){
			_this.loadPdf(localPath, url, external_url, file.originalFilename, function(appInstance){
				callback(appInstance);
			});
		}
	});
