...
module.exports.loadVideo = function(vid_url, external_url, id, title, callback) {
...
module.exports.loadPdf = function(pdf_url, external_url, id, title, callback) {
...
module.exports.loadApp = function(zip_url, id, callback) {
	...
	fs.readFile(instuctionsFile, 'utf8', function(err, json_str) {
		...
		callback(new item(instructions.type, zipName, id, path.join(zipFolder, instructions.main_script), null, 0, 0, instructions.width, instructions.height, aspect, now, zipFolder+path.sep, objName), instructions);
	});
}
